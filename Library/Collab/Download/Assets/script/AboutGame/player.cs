...
public class player : MonoBehaviour
{
                      ...
                      //現在は絶対位置で移動量を管理しているが、今後変更する予定あり
    {
        ...
        sendr = 127;
        sendl = 127;
        sendq = (int)((170 + (Turret.r - (GameObject.Find("turret").transform.rotation.z*180/Mathf.PI))) % 340) * 255 / 340;
        Debug.Log((GameObject.Find("turret").transform.rotation.y * 180 / Mathf.PI));
        if (sendq < 1)
        {
            sendq = 7;
